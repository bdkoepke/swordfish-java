...
public class XmlContext<T> {
	...
	public static class Builder<T> {
		...
		private final Map<String, Object> _marshallerProperties = Maps.newHashMap();
		private final Map<String, Object> _unmarshallerProperties = Maps.newHashMap();
		...
		public XmlContext<T> build(Class<T> type, Class... types) throws JAXBException {
			...
			return new XmlContext<T>(marshaller, unmarshaller);
		}
	}
